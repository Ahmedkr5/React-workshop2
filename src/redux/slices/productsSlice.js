...
initialState,
reducers: {
populateProducts(state, action) {               /*fct prend state et action pour avoir accès a initial state  et                                              
                                                maj liste des prods dans l'état(initialstate) par ce qui été passé en param dans l'action */
